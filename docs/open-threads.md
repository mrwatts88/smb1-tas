...
## THE LIVE BOARD — **three live threads** (2026-08-25 s22), and that is all of it

**s22 update:** L3 is **parked** (below), so the board is now **L1 (8-2), L4 (8-4 room 2), L7 (8-4 novelty
sweep)** — two of the three in 8-4, the only level where one frame is the record. Everything else is either
closed with an artifact or a *lens* rather than a campaign.
